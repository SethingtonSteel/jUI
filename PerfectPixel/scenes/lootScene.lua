...
----titleControl---------------------------------
	...
	PP.Font(titleControl, --[[Font]] PP.f.Expressway, 22, "outline", --[[Alpha]] nil, --[[Color]] nil, nil, nil, nil, --[[StyleColor]] 0, 0, 0, .8)
...
-------------------------------------------------
	...
	PP.Font(ZO_LootStealthIconStealthText, --[[Font]] PP.f.Expressway, 24, "outline", --[[Alpha]] 1, --[[Color]] nil, nil, nil, nil, --[[StyleColor]] 0, 0, 0, .8)

	PP.Anchor(button1, --[[#1]] BOTTOMRIGHT, alphaControl, BOTTOMRIGHT, -10, -10)

	PP.Font(button1.keyLabel,	--[[Font]] PP.f.Expressway, 16, "outline", --[[Alpha]] nil, --[[Color]] nil, nil, nil, nil, --[[StyleColor]] 0, 0, 0, .5)
	PP.Font(button1.nameLabel,	--[[Font]] PP.f.Expressway, 18, "outline", --[[Alpha]] nil, --[[Color]] nil, nil, nil, nil, --[[StyleColor]] 0, 0, 0, .5)
	PP.Font(button2.keyLabel,	--[[Font]] PP.f.Expressway, 16, "outline", --[[Alpha]] nil, --[[Color]] nil, nil, nil, nil, --[[StyleColor]] 0, 0, 0, .5)
	PP.Font(button2.nameLabel,	--[[Font]] PP.f.Expressway, 18, "outline", --[[Alpha]] nil, --[[Color]] nil, nil, nil, nil, --[[StyleColor]] 0, 0, 0, .5)
-------------------------------------------------
