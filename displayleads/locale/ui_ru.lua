...
RDL.DropdownData = {
	ChoicesMajor  = { "Можно найти", "Можно выкопать", "Не все записи кодекса", "Ни разу не выкопанные", "Активные ", "Все", "Групповые подземелья", "Маркарт",},
	...
	TooltipsMajor  = {
		...
		"Показать только новые зацепки из дополнения 'Маркарт'",
	},
