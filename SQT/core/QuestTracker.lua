...
local NodeFonts = {
	...
	[9] = {name = "Expressway", 			font = "Expressway"},
...
local NodeOutlines = {
	...
	[5] = {name = "Soft Thin Shadow", 	outline = "soft-shadow-thin"},
	[6] = {name = "Soft Thick Shadow", 	outline = "soft-shadow-thick"},
...
function QuestTracker:New()
    ...
    self.svAccount = ZO_SavedVars:NewAccountWide("SQTSavedVars", 3.0, nil, defaultSV)
    self.svCharacter = ZO_SavedVars:New("SQTSavedVars", 3.0, nil, defaultSV)
