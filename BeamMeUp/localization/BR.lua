...
mkstr(SI.TELE_UI_BTN_RELATED_ITEMS, "Mapas de Tesouro e Mapas de Pesquisa e Leads\n|c777777(click com botão direito p/ mais informações)")
...
mkstr(SI.TELE_CHAT_WHISPER_NOTE, "Atenção! Você está definido para offline e não pode receber nenhuma mensagem particular!")
...
mkstr(SI.TELE_SETTINGS_WHISPER_NOTE, "Nota de sussurro")
mkstr(SI.TELE_SETTINGS_WHISPER_NOTE_TOOLTIP, "Quando você está definido para offline e sussurra alguém, você receberá uma nota no bate-papo, que você não pode receber nenhuma mensagem de sussurro. Esse recurso ajuda você a evitar bloqueios indesejados de respostas.")
...
mkstr(SI.TELE_SETTINGS_PRIORITIZATION_DESCRIPTION, "Aqui você pode definir quais jogadores devem ser usados de forma rápida. Depois de sair ou unir uma guilda, um reinicio de UI é necessária para ser exibida corretamente aqui. |ca20000Esta opção está vinculada ao seu personagem (não há conta)!|r")
mkstr(SI.TELE_SETTINGS_SCAN_BANK_FOR_MAPS, "Pesquisar no seu banco por mapas")
mkstr(SI.TELE_SETTINGS_SCAN_BANK_FOR_MAPS_TOOLTIP, "Além disso, pesquisa no seu banco para mapas de tesouro e mapas de pesquisa.")
...
mkstr(SI.TELE_SETTINGS_SCAN_LEADS, "Mostrar scryable leads")
mkstr(SI.TELE_SETTINGS_SCAN_LEADS_TOOLTIP, "Exibe seus leads scryble junto com mapas de tesouro e mapas de pesquisa.")
