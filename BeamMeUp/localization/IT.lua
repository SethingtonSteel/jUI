...
mkstr(SI.TELE_UI_BTN_RELATED_ITEMS, "Mappe del Tesoro & Mappe di Ricerca & Indizi\n|c777777(right-click for more options)")
...
mkstr(SI.TELE_CHAT_WHISPER_NOTE, "Attenzione! Sei impostato su offline e non puoi ricevere alcun messaggio privato!")
...
mkstr(SI.TELE_SETTINGS_WHISPER_NOTE, "Sussurra Note")
mkstr(SI.TELE_SETTINGS_WHISPER_NOTE_TOOLTIP, "Quando si è impostato lo stato offline e si sussurra a qualcuno, si otterrà una nota nella chat, che non è possibile ricevere alcun messaggio sussurrato. Questa funzione ti aiuta ad evitare il blocco indesiderato delle risposte.")
...
mkstr(SI.TELE_SETTINGS_PRIORITIZATION_DESCRIPTION, "Qui puoi definire quali giocatori dovrebbero preferibilmente essere utilizzati per i viaggi veloci. Dopo aver lasciato o esserti unito ad una gilda, un reload è necessario per essere visualizzato correttamente |ca20000Questa opzione è collegata al tuo personaggio (non a livello di account)!|r")
mkstr(SI.TELE_SETTINGS_SCAN_BANK_FOR_MAPS, "Scansiona le Mappe nella tua Banca")
mkstr(SI.TELE_SETTINGS_SCAN_BANK_FOR_MAPS_TOOLTIP, "Inoltre scansiona la tua banca in cerca delle mappe del tesoro e di ricerca.")
...
mkstr(SI.TELE_SETTINGS_SCAN_LEADS, "Mostra indizzi individuabili")
mkstr(SI.TELE_SETTINGS_SCAN_LEADS_TOOLTIP, "Mostra i tuoi indizzi individuabili insieme alle mappe di ricerca e del tesoro")
