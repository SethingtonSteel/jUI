...
-- Settings panel
	...
	L.ESOMRL_NOFILTERS			= "Clear filters on startup"
	L.ESOMRL_NOFILTERSD			= "Automatically un-check the 'Have Ingredients' and 'Have Skills' filters when you first open the cooking station."
