...
--[[100034
hasJumpPoints=DoesChampionSkillHaveJumpPoints(*integer* _championSkillId_)
jumpPoint=GetChampionSkillJumpPoints(*integer* _championSkillId_)
...
function BUI.Champion_Init()
	if not BUI.Vars.ChampionHelper or BUI.API>100033 then
