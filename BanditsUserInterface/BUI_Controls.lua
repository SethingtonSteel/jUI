...
local fonts={
	...
	esobold		="LMP_MediaStash/fonts/Expressway.ttf",
	...
	ExpresswayBUI	="LMP_MediaStash/fonts/Expressway.ttf",
...
function BUI.UI.Font(font, size, shadow, outline)
	...
	local shadow=shadow and '|outline' or ''
	if outline then shadow='|outline' end
