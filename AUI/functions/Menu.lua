...
function AUI.Menu.GetFontTypeList()
	local fontTypeList = 
	{
		...
		[13] = {["AUI/fonts/Expressway.ttf"]								= "Expressway"},
	    [14] = {["AUI/fonts/Bellota-Bold.otf"]								= "Bellota"},
		[15] = {["esoui/common/fonts/eso_fwudc_70-m.ttf"]					= "ESO-FWUDC_70 M"},
		[16] = {["esoui/common/fonts/eso_fwntlgudc70-db.ttf"]				= "ESO-FWNTLGUDC70 DB"},
	}
