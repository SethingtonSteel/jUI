...
USPF.Options = {
	Font = {
		...
		Names = {"ProseAntique", "Consolas", "Futura Condensed", "Futura Condensed Bold", "Futura Condensed Light", "Skyrim Handwritten", "Trajan Pro", "Univers 55", "Univers 57", "Univers 67", "Expressway"},
	},
	Sort = {
		SQS = {
			["Legacy Zone"]		= 1,
